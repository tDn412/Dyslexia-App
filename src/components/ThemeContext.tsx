...
export function ThemeProvider({ children }: { children: ReactNode }) {
    ...
    // Load theme from localStorage on mount (Backup, but mainly will use SettingsContext to sync)
    useEffect(() => {
    ...
    const applyTheme = (theme: ThemeType) => {
        ...
        root.style.setProperty('--preview-border', colors.previewBorder); // Added this one
    };
